...
<div class="container">
    ...
    <div class="row mt-4">
        <div class="col">
            ...
            <hr>
            <p>Untuk pembayaran silahkan dapat transfer di rekening dibawah ini sebesar : 
            <strong>Rp. {{ number_format($total_harga) }}</strong></p>
            <div class="media">
                <img class="mr-3" src="{{ url('assets/bri.png') }}" alt="Bank BRI" width="60px">
                <div class="media-body">
                    <h5 class="mt-0">BANK BRI</h5>
                    No. Rekening 06835-021-234 atas nama <strong>Fadel Nur Akhmad</strong>
                </div>
            </div>
        </div>
        <div class="col">
            ...
            <hr>          
            <!-- prevent untuk menghilangkan fungsi aslinya -->
            <form wire:submit.prevent="checkout">
                ...
                <button type="submit" class="btn btn-success btn-block"><i class="fas fa-arrow-right"></i> Checout</button>            
            </form>
        </div>
    </div>
</div>

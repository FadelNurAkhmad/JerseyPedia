                    ...
                    <tbody>
                        ...
                        @forelse ($pesanan_details as $pesanan_detail)
                            <tr>
                                ...
                                <td>{{ number_format($pesanan_detail->product->harga) }}</td>
                                <td><strong> {{ number_format($pesanan_detail->total_harga) }}</strong></td>
                                <td>
                        ...
                        <tr>
                                ...
                                <td align="right"><strong>{{ number_format($pesanan->total_harga) }}</strong></td>
                                <td></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td align="right"><strong>{{ number_format($pesanan->total_harga+$pesanan->kode_unik) }}</strong></td>
                                <td></td>
                            </tr>
                            <tr>
                                <td colspan="6"></td>
